    ...
    public class HomePageViewModel : BindableBase
    {
        ...
        public void SetLayout()
        {
            LayoutPages = new ObservableCollection<LayoutPageModel>()
            {
                ...
                new LayoutPageModel() {Type = 1, Image = "", Title = "Sách miễn phí", ListBook = new ObservableCollection<Book>(App.Books.Where(b => b.IsPremium == false))},
                ...
                new LayoutPageModel() {Type = 1, Image = "", Title = "Mới phát hành", ListBook = new ObservableCollection<Book>(App.Books.Skip(3))},
                ...
                new LayoutPageModel() {Type = 1, Image = "", Title = "Xây dựng mối quan hệ", ListBook =  new ObservableCollection<Book>(App.Books.Skip(5).Take(5))},
